...
export default function Hero() {
  ...
  if (!mounted) {
    return (
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-gray-950">
        <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 py-12 sm:py-20 md:py-28">
  ...
  return (
    <section className="relative min-h-[90dvh] flex items-center overflow-hidden bg-gray-950">
      {/* Video background - desktop only */}
      <video
        key={currentVideo}
        className={`absolute inset-0 z-0 h-full w-full object-cover transition-opacity duration-1000 hidden sm:block ${
      ...
      {/* Static image - mobile always, desktop while video loads */}
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img
        className={`absolute inset-0 z-0 h-full w-full object-cover sm:transition-opacity sm:duration-1000 opacity-35 ${
          videoLoaded ? "sm:opacity-0" : "sm:opacity-35"
        }`}
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 py-12 sm:py-20 md:py-28 isolate transform-gpu">
        <div className="text-center">
          <div
